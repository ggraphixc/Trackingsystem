...
export function LeafIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 21v-8.25M15.75 21v-5.25M8.25 21v-3.75m9-10.5c0-4.5-6-4.5-6 0m6 0c0 3.75-2.25 6-6 6m6-6h-6m-6 0c0-4.5 6-4.5 6 0m-6 0c0 3-2.25 4.5-6 6" />
    </svg>
  );
}
...
export function SignalIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M15.75 5.25v13.5m-7.5-13.5v13.5m-3.75-6v6m15-12v12M8.25 15v3.75m7.5-3.75v3.75" />
    </svg>
  );
}
...
export function BatteryIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M21 10.5h.375c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125H21M3.75 18h15A2.25 2.25 0 0 0 21 15.75v-7.5A2.25 2.25 0 0 0 18.75 6h-15A2.25 2.25 0 0 0 1.5 8.25v7.5A2.25 2.25 0 0 0 3.75 18Z" />
    </svg>
  );
}
...
export function CrosshairIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M12 2.25v3m0 13.5v3M21.75 12h-3m-13.5 0h-3M18.53 5.47l-2.12 2.12M7.59 16.41l-2.12 2.12m0-12.06 2.12 2.12m10.94 10.94-2.12-2.12" />
    </svg>
  );
}
...
export function RecycleIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M7.5 7.5h-.75A2.25 2.25 0 0 0 4.5 9.75v7.5a2.25 2.25 0 0 0 2.25 2.25h7.5a2.25 2.25 0 0 0 2.25-2.25v-7.5a2.25 2.25 0 0 0-2.25-2.25h-.75m-6 3.75 3 3m0 0 3-3m-3 3V1.5m6 9h.75a2.25 2.25 0 0 1 2.25 2.25v7.5A2.25 2.25 0 0 1 18 22.5h-7.5a2.25 2.25 0 0 1-2.25-2.25v-.75" />
    </svg>
  );
}
...
export function AlarmIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0M3.965 2.906a5.582 5.582 0 0 0-1.93 6.842M20.97 2.906a5.582 5.582 0 0 1 1.93 6.842" />
    </svg>
  );
}
